...
{
    [AllowAnonymous]
    public class RegisterJuridicModel : PageModel
    {
        private readonly SignInManager<IdentityUser> _signInManager;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly ILogger<RegisterJuridicModel> _logger;
        private readonly IEmailSender _emailSender;
        private readonly BankDbContext _dbContext;

        public RegisterJuridicModel(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            ILogger<RegisterJuridicModel> logger,
        ...
        [BindProperty] public JuridicPerson JuridicPersonInputModel { get; set; }
